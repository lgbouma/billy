...
magnitudes.
CVSO~35 also shows a strong Wide-field Infrared Survey Exoplorer
(WISE, \citealt{wright_WISE_2010}) IR excess as well as a 10$\mu$m silicate
...
% LGB: Seems unlikely, because we're seeing a something with constant
% 10.74 hour periodicity, but the phase is offset by 1/9th.
% If both stars were dippers, we would be seeing a 11.98 hour
% periodicity instead.
...
\begin{enumerate}[topsep=0.5ex,itemsep=-0.5ex,partopsep=1ex,parsep=1.5ex]
  ...
  young M2-M5 stars \citep{rebull_usco_2018}.
\end{enumerate}
The 10.76$\,$hr signal in \ptfo\ meets all of these criteria.  This is
the first connection of \ptfo\ with this class of objects, 
likely because the TESS data enabled us to put the dips in 
the context of the asymmetric out-of-dip modulation.
