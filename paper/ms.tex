...
\citep{zhan_complex_2019},
the ``blobs'' that provide the necessary
brightness contrast are on the surface of the star, rather than at the co-rotation
radius. The observing geometry would
require an inner ring to be projected into a narrow band in front of the
stellar disk, in order to produce variations with sufficiently
short timescales. 
% The outer disk would need to either not be present,
% or to be misaligned enough, and narrow enough, that it did not fall
% along the line of sight.
% JNW Doesn't this same problem affect the "dusty torus" model?
This geometric requirement seems too contrived to occur in even
$\lesssim$1\% of young M dwarf systems. }
...
% JNW Doesn't seem worth beating on a dead horse.
