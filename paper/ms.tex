...
Interpreting the second cosine harmonic as being caused by a planet,
...
a useful exercise.  To our knowledge, of order 10 lightcurves with
...
These lightcurves have been classified phenomenologically as
...
This class of objects has the following properties.
\begin{enumerate}
  \item Weak-lined T Tauri stars.
  \item Spectral type typically M2-M5 ({\it e.g.},
    \citet{rebull_usco_2018}~Figure~20).
  ...
  \item Phased lightcurves show shallow, angular dips, usually
    superposed on large-amplitude smooth variability (interpreted as
    stellar rotation).
  \item Rotation is usually rapid ($P<1\,{\rm day}$).
  ...
  \item Can show multiple dips per cycle ({\it e.g.}, EPIC 203692610,
    RIK-210).
  \item Dip depths, durations, and phasescan vary over timescales of days
    ({\it e.g.}, EPIC 204143627).
  \item Dip depths can change after flares ({\it e.g.}, RIK-210.
  \item Rare ($\lesssim 1\%$ of relevant stars) at a population level
