...
be the youngest known \added{transiting\footnote{Two younger hot
Jupiters have been reported around V830 Tau and TAP 26
\citep{donati_hot_2016,donati_hot_2017,yu_hot_2017}.}} hot Jupiter
\citep{van_eyken_ptf_2012}, orbiting a T Tauri star in the Orion-OB1a
cluster.  It would have the shortest orbital period of any hot
Jupiter.  With such a short period, it would probably be filling its
Roche lobe, and actively losing mass to its host star.  Not only that,
but the rapidly-rotating host star is probably oblate enough to
\replaced{torque the planet's orbit into and out of the transiting
configuration}{cause the planet's orbit to precess into and out of the
transiting configuration} on a timescale of years
