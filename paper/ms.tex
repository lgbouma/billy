...
in fact mentioned by \citet{stauffer_orbiting_2017}, the
...
and so \replaced{are apparently}{could be} binaries
\citep[][Table~1]{stauffer_orbiting_2017}.  This is higher than the
main-sequence companion fraction of ${\rm
CF}_{0.1\text{-}0.5\,M_\odot}^{\rm MS} = 33 \pm 5\%$\added{, and so it
...
could exist around single stars inside, at, or wide of co-rotation.
If it did, it could eclipse with a period different from the stellar
rotation.
...
over}{Observations of \ptfo\ from} the past decade may offer some
hints.  \deleted{Specifically, }\ptfo's transition between having
none, one, and multiple dips per cycle seems important
...
The high-latitude accretion hotspot scenario seems qualitatively
capable of explaining most of the characteristics of \ptfo, including
the fact that its H$\alpha$ equivalent width of 11.4$\,$\AA\
\citep{van_eyken_ptf_2012} places it near the ``classical/weak'' T
Tauri division \citep{briceno_cidaII_2019}, and the fact that its
excess H$\alpha$ component varies in velocity between $-200$ and
$+200$ km$\,$s$^{-1}$ \citep{johnskrull_h_2016}.  The lack of a
NIR-excess could be problematic, but does not eliminate the
possibility that a tenuous amount of dust or gas remains near the
star, and is able to accrete onto it.  We view the main problem with
this explanation to be the likelihood that it explains the population
of transient flux dips.  RIK-210 in particular has dips too deep
...
misaligned enough and insufficiently flared, that it did not fall
along the line of sight.  This geometric requirement seems too
contrived to occur in even $\lesssim$1\% of young M dwarf systems. }

\added{Out of the available explanations, we therefore consider the
