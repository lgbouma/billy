...
be the youngest known \added{transiting} hot Jupiter \citep{van_eyken_ptf_2012}, orbiting
...
The model of starspot occultations by an optically thick disk \citep{zhan_complex_2019}
is a qualitative inverse of the torus of circumstellar material:
the difference is whether to place the ``blobs'' that
provide the needed brightness contrast on the
surface of the star, or at the co-rotation radius.
}
...
gas near the co-rotation radius easily explains this excess,
while the starspot occultation model does not.
}
