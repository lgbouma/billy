...
\begin{abstract}
  ...
  clarify whether it is actually a planet.  The Gaia data show that
  ...
  shows the long rotation signal, and the other star is showing
...
proposed by {\it e.g.}, \citet{stauffer_orbiting_2017} and
...
In addition, a number of other young stars show similar lightcurve
morphologies.  We therefore argue that PTFO$\,$8-8695 is a binary M
dwarf in which one star shows a rotation signal, and the other is
showing ``transient dipping'' that is likely caused by eclipses of
clouds of material at the Keplerian co-rotation radius.
...
These CCD observations were used to estimate positions, proper
motions, and parallax for the brighest 1{.}3 billion stars, including
\ptfo.  There were 121 ``good'' observations of \ptfo, {\it i.e.},
observations that were not strongly downweighted in the astrometric
solution of the source.  The star was assigned a Gaia DR2 identifier
...
Spectrometer \citep{cropper_gaia_2018,evans_gaia_2018}.
