...
\begin{abstract}
  ...
  by 1.2\% hour-long dips, the type of signal previously
...
% JNW: this kind of stuff is for the abstract/conclusion, not intro.
%The phase of the dip within the seems
...
%lasma at the Keplerian co-rotation radius.

\section{The Data}
\label{sec:observations}

% JNW: How about more descriptive labels? f --> Total flux
% fl = Longer-period signal
% fs = Shorter-period signal
% last panel, Residuals
...
\ptfo\ [also known as CVSO\,30; \cite{briceno_cida_2005}}]
...
% JNW: What does that mean? You used fractional pixels in calculating the pixel sums?
...
% JNW: What's the difference between a CMD and an HR diagram?
...
% JNW This doesn't seem necessary to me.
...
% JNW what does that mean? If you just mean 'numpy', is it necessary to state?
...
%photometric binary was of great interest.  
...
% JNW: Don't understand this sentence. What is the 'same signal'?
...
sidereal day.
% JNW What is this next phrase doing here?
%While the TESS data can show significant reflected
%light from the Earth \citep[{\it e.g.},][]{luger_tess_2019}, 
Our
...
%  \item They lack spectroscopic indicators of strong accretion.
% JNW: Same as WTTS?
...
evolution.
% JNW I wonder if there could be a circumbinary ring, a la KH 15D.
...
% JNW: seems like a stretch but I will not strike it down
