...
variability classes remains open.}{ The model of hot and coldspot
occultations by an optically thick disk \citep{zhan_complex_2019} is a
qualitative inverse of the torus of circumstellar material: the
difference is whether to place the ``blobs'' that provide the needed
brightness contrast on the surface of the star, or at the co-rotation
radius.  In the spot occultation model, the observing geometry would
require an inner disk to be projected into a narrow band across the
stellar surface, in order to produce variations with sufficiently
short timescales.  The outer disk would need either to not be present,
or to be misaligned enough, and narrow enough, that it did not fall
along the line of sight. These combined requirements seem
geometrically contrived.  }
...
cycle seems important \added{(Figure~\ref{fig:o_minus_c})}.  It
strains the ``enshrouded protoplanet'' interpretation, because there
are no known processes that cause a planet's orbital phase to jump.
...
wall'' within which all dust evaporates
\citep{millan-gabet_circumstellar_2007,dullemond_inner_2010} will
likely be an important first-order consideration in physical models of
...
continuum, atomic lines, or perhaps TiO molecular opacity) remains a
